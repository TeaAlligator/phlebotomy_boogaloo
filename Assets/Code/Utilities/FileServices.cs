    ...
    public class FileServices {
        ...
        private static string AddFolderToList(FileSystemInfo folder, string list, int tabCount = 0)
        {
            ...
            * */
            ...
            var files = GetFileNamesFromFolder(folder.FullName, ".png", ".json", ".jpg", ".ttf", ".ogg", ".mp3", ".wav");
        ...
        {
            _resourcesList = LoadTextResource(resourcesListPath).Split('\n');
        }
        ...
        public static string GetFileNameFromResourcePath(string ResourceFolderPath)
        {
        ...
        public static string LoadTextFile(string targetFile)
        {
            if (targetFile == null)
                return null;
        ...
        public static string LoadTextResource(string targetResource)
        {
        ...
        public static Texture2D LoadTextureResource(string targetResource)
        {
            ...
            texture.name = GetFileNameFromResourcePath(resourcePath);
        ...
        public static AudioClip LoadAudioResource(string targetResource)
        {
            ...
            sound.name = GetFileNameFromResourcePath(resourcePath);
